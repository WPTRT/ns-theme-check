...
* Download [zip file](https://github.com/WPTT/theme-sniffer/releases/download/1.1.2/theme-sniffer.zip). **Note**: Please use this distribution plugin zip. GitHub provided zip will not work.
